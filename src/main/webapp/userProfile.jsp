    ...
    <div class="w3-col m3">
      ...
      <div class="w3-container">
			 <% Users u = (Users)session.getAttribute("user"); %>
			  <img id="myImg" src="<%=(u.getImgpath() != null) ? u.getImgpath() : "images/img-profile-missing.png" %>" class="w3-circle" style="height:106px;width:106px" alt="Avatar">
