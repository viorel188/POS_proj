...
INSERT INTO `liketable` VALUES (1,NULL,57,58),(26,NULL,53,52),(27,NULL,56,57),(28,NULL,58,57),(30,NULL,67,62),(31,NULL,68,62),(34,NULL,66,64),(35,NULL,67,64),(36,NULL,68,64),(37,NULL,70,64),(38,NULL,69,62),(39,NULL,57,56);
...
CREATE TABLE `privatemessage` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `created` varchar(99) DEFAULT NULL,
  `id_user` int(11) NOT NULL,
  `dest_user_id` int(11) NOT NULL,
  `message_body` varchar(800) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idUserPMT_idx` (`id_user`),
  KEY `destUserIDPMT_idx` (`dest_user_id`),
  CONSTRAINT `destUserIDPMT` FOREIGN KEY (`dest_user_id`) REFERENCES `users` (`id`),
  CONSTRAINT `idUserPMT` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`)
...
INSERT INTO `privatemessage` VALUES (1,'21:44 30/05/2019',56,57,'sdfs'),(2,'21:44 30/05/2019',56,57,'aa'),(3,'21:45 30/05/2019',57,56,'sdf'),(4,'21:51 30/05/2019',56,57,'dsf'),(5,'21:53 30/05/2019',57,56,'hey babe'),(6,'21:53 30/05/2019',57,56,'gimme a smile'),(7,'21:53 30/05/2019',57,56,'and I\'ll give u mine!'),(8,'21:53 30/05/2019',56,57,'fck off dude'),(9,'21:57 30/05/2019',57,58,'sdfdsaf'),(10,'21:58 30/05/2019',57,56,'asdf'),(11,'21:58 30/05/2019',56,57,'asdfasdfsa'),(12,'21:58 30/05/2019',57,56,'heyy'),(13,'22:21 30/05/2019',57,56,'hey'),(14,'22:21 30/05/2019',56,57,'hello'),(15,'22:22 30/05/2019',56,57,'hey hey hey');
...
-- Dump completed on 2019-05-30 22:28:55
